...
def set_velocity_body(vehicle, vx, vy, vz):
    ...
    msg = vehicle.message_factory.set_position_target_local_ned_encode(
        0,
        0, 0,
        mavutil.mavlink.MAV_FRAME_BODY_OFFSET_NED, #MAV_FRAME_BODY_NED,
...
class DetectThread(threading.Thread):
    ...
    def run(self):
        # cap = detectTest.camInit(0)
        # detectTest.targetDetect(cap)
...
# myCopter.initialize(simulation = True)
...
while True:
    ...
    if mode == 'GROUND':
        ...
        # PI = 3.1415
        try:
        #     pos_forward, pos_right = object_track.get_offset()
        #     if math.fabs((last_forward - pos_forward) / (pos_forward + 0.01)) > 0.1 or \
        #             math.fabs((last_right - pos_right) / (pos_right + 0.01)) > 0.1:
        #         print("x=%.2f, y=%.2f" % (pos_right, pos_forward))
        #         # vehicle.goto(pos_right, pos_forward, 0)
        #         # vehicle.send_nav_velocity(pos_right, pos_forward, 0)
        #         set_velocity_body(vehicle, pos_right, pos_forward, 0.0)
        #         # time.sleep(3)
        #     print(vehicle.velocity)
        #     print(vehicle.groundspeed)
        #     last_right = pos_right
        #     last_forward = pos_forward
